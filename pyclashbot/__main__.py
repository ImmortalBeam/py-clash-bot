...
def make_job_dictionary(values: dict[str, Any]) -> dict[str, Any]:
    ...
    job_dictionary: dict[str, Any] = {
        ...
        UIField.PLAY_AGAIN_USER_TOGGLE.value: as_bool(UIField.PLAY_AGAIN_USER_TOGGLE),
        UIField.MAX_PLAY_AGAIN_SELECTION.value: as_int(UIField.MAX_PLAY_AGAIN_SELECTION, 5),
